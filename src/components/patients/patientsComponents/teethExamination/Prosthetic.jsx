...
const Prosthetic = ({ data, onChange }) => {
    ...
    return (
        <div className="mt-10">
            <h2 className="text-lg font-semibold mb-4">
                9. Prosthetic Treatment Plan for Specific Teeth
            </h2>
            ...
            <div className="flex gap-3 mt-4">
                <Button onClick={handleApply} className="bg-[#67C090] hover:bg-[#67C090] text-white px-4 py-2 rounded-lg text-sm cursor-pointer">
                    Apply
                </Button>
                <Button onClick={handleClearTemp} className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm cursor-pointer">
                    Clear Selection
                </Button>
            </div>
