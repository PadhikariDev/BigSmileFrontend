...
const Decayed = ({ data = {}, onChange }) => {
    ...
    // ✅ Decide if tooth should show selected (temp OR already applied)
    const isToothSelected = (tooth) =>
        tempTeeth.includes(tooth) || Object.keys(data).includes(String(tooth));

    return (
        <div className="mt-10">
            <h2 className="text-lg font-semibold mb-4">2. Permanent Decayed Teeth</h2>
