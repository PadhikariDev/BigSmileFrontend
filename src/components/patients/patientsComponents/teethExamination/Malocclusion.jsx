...
const Malocclusion = ({ data = {}, onChange }) => {
    ...
    // ✅ No separate mirror — just rely on props
    ...
    return (
        <div className="mt-10">
            <h2 className="text-lg font-semibold mb-4">5. Permanent Teeth Malocclusion</h2>
