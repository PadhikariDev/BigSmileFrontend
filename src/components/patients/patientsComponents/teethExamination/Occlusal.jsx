...
const Occlusal = ({ data = {}, onChange }) => {
    // Fixed list of Occlusal conditions
    const [conditions] = useState(["Abrasion", "Erosion", "Attrition", "Abfraction"]);
    ...
    const handleApply = () => {
        ...
        tempTeeth.forEach((tooth) => {
            ...
            updated[tooth] = Array.from(
                new Set([...(updated[tooth] || []), ...tempConditions])
            );
        });

        onChange(updated); // push data to parent
    ...
    return (
        <div>
            <h2 className="text-lg font-semibold mb-4">1. Occlusal Disease</h2>
            ...
            <div className="flex gap-3 mt-4">
                <Button
                    type="button"
                    onClick={handleApply}
                    className="bg-[#67C090] hover:bg-[#67C090] cursor-pointer text-white px-4 py-2 rounded-lg text-sm"
                >
                    Apply
                </Button>
                <Button
                    ...
                    className="bg-red-600 hover:bg-red-700 cursor-pointer text-white px-4 py-2 rounded-lg text-sm"
                >
                    Clear Selection
                </Button>
            </div>
